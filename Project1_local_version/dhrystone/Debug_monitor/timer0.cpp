...
//    DigitalOut BugMe (PTB9);   // debugging information out on PTB9      
	...
	volatile uint8_t RED_LED_Flag = 0;
	volatile uint8_t FLAG_100us = 0;
#ifdef __cplusplus
}
#endif
...
// Re-enable interrupts and return
   ...
   SwTimerIsrCounter++;
		 ...
		 if(System_Timer_count == 300000) //count for 30sec
		 {
			 UART_msg_put("\n\r30 sec timer0 count = ");
			 UART_hex_put((timer0_count&0XFF00)>>8);
			 UART_hex_put(timer0_count);
			 UART_msg_put("\n\r");	 
		 }
